...
* Install a few tools ahead of time: sudo apt-get install curl unzip git-core uuid-dev
...
After that the rest of the Tir installation instructions went through perfectly and I was left with a working installation of Tir, using Mongrel 2, on a Ubuntu box inside a VM managed by Vagrant. Thoughts of Inception float through my head. 
